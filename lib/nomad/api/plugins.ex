...
defmodule Nomad.Api.Plugins do
  @moduledoc """
  ...
  """
  @spec get_plugin_csi(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, list(Nomad.Model.CsiPlugin.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_plugins(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(Nomad.Model.CsiPluginListStub.t)} | {:error, Tesla.Env.t}
  def get_plugins(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%Nomad.Model.CsiPluginListStub{}]},
      {400, false},
      {403, false},
      {405, false},
      {500, false}
