...
defmodule Nomad.Api.Scaling do
  @moduledoc """
  ...
  """
  @spec get_scaling_policies(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(Nomad.Model.ScalingPolicyListStub.t)} | {:error, Tesla.Env.t}
  def get_scaling_policies(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, [%Nomad.Model.ScalingPolicyListStub{}]},
      {400, false},
      {403, false},
      {405, false},
      {500, false}
  ...
  - `{:ok, Nomad.Model.ScalingPolicy.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_scaling_policy(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.ScalingPolicy.t} | {:error, Tesla.Env.t}
