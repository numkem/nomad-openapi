...
defmodule Nomad.Api.Nodes do
  ...
  """
  @spec get_node(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.Node.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_node_allocations(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, list(Nomad.Model.AllocationListStub.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_nodes(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(Nomad.Model.NodeListStub.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_node_drain(Tesla.Env.client, String.t, Nomad.Model.NodeUpdateDrainRequest.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.NodeDrainUpdateResponse.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_node_eligibility(Tesla.Env.client, String.t, Nomad.Model.NodeUpdateEligibilityRequest.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.NodeEligibilityUpdateResponse.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, Nomad.Model.NodePurgeResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_node_purge(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.NodePurgeResponse.t} | {:error, Tesla.Env.t}
  def update_node_purge(connection, node_id, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %Nomad.Model.NodePurgeResponse{}},
      {400, false},
      {403, false},
      {405, false},
      {500, false}
