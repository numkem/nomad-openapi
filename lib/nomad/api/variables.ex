...
defmodule Nomad.Api.Variables do
  @moduledoc """
  ...
  """
  @spec delete_variable(Tesla.Env.client, String.t, Nomad.Model.Variable.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  - `{:ok, Nomad.Model.Variable.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_variable_query(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.Variable.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_variables_list_request(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(Nomad.Model.VariableMetadata.t)} | {:error, Tesla.Env.t}
  def get_variables_list_request(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, [%Nomad.Model.VariableMetadata{}]},
      {400, false},
      {403, false},
      {405, false},
      {500, false}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_variable(Tesla.Env.client, String.t, Nomad.Model.Variable.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.Variable.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec put_variable(Tesla.Env.client, String.t, Nomad.Model.Variable.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.Variable.t} | {:error, Tesla.Env.t}
