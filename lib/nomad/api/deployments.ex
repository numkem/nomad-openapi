...
defmodule Nomad.Api.Deployments do
  @moduledoc """
  ...
  """
  @spec get_deployment(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.Deployment.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_deployment_allocations(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, list(Nomad.Model.AllocationListStub.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_deployments(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, list(Nomad.Model.Deployment.t)} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_deployment_allocation_health(Tesla.Env.client, String.t, Nomad.Model.DeploymentAllocHealthRequest.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.DeploymentUpdateResponse.t} | {:error, Tesla.Env.t}
  def post_deployment_allocation_health(connection, deployment_id, deployment_alloc_health_request, opts \\ []) do
    optional_params = %{
      :region => :query,
      :namespace => :query,
      :"X-Nomad-Token" => :headers,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_deployment_fail(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.DeploymentUpdateResponse.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_deployment_pause(Tesla.Env.client, String.t, Nomad.Model.DeploymentPauseRequest.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.DeploymentUpdateResponse.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_deployment_promote(Tesla.Env.client, String.t, Nomad.Model.DeploymentPromoteRequest.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.DeploymentUpdateResponse.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_deployment_unblock(Tesla.Env.client, String.t, Nomad.Model.DeploymentUnblockRequest.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.DeploymentUpdateResponse.t} | {:error, Tesla.Env.t}
