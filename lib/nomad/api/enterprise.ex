...
defmodule Nomad.Api.Enterprise do
  @moduledoc """
  ...
  """
  @spec create_quota_spec(Tesla.Env.client, Nomad.Model.QuotaSpec.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_quota_spec(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  - `{:ok, Nomad.Model.QuotaSpec.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_quota_spec(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Nomad.Model.QuotaSpec.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_quotas(Tesla.Env.client, keyword()) :: {:ok, list(any())} | {:ok, nil} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_quota_spec(Tesla.Env.client, String.t, Nomad.Model.QuotaSpec.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
